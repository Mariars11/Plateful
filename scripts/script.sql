...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Consumo_Item_Usuario](
	[ID_CONSUMO] [int] IDENTITY(1,1) NOT NULL,
	[ID_ITEM] [int] NOT NULL,
	[ID_ESTABELECIMENTO] [int] NOT NULL,
	[ID_USUARIO] [int] NOT NULL,
	[FLAG_CONSUMIDO] [bit] NOT NULL,
 CONSTRAINT [PK_Consumo_Item_Usuario] PRIMARY KEY CLUSTERED 
(
	[ID_CONSUMO] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Estado_Cliente_Estabelecimento](
	[ID_ESTADO_CLIENTE_ESTABELECIMENTO] [int] IDENTITY(1,1) NOT NULL,
	[ID_ESTADO] [tinyint] NOT NULL,
	[ID_USUARIO] [int] NOT NULL,
	[ID_ESTABELECIMENTO] [int] NOT NULL,
 CONSTRAINT [PK_Estado_Cliente_Estabelecimento] PRIMARY KEY CLUSTERED 
(
	[ID_ESTADO_CLIENTE_ESTABELECIMENTO] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[Consumo_Item_Usuario]  WITH CHECK ADD  CONSTRAINT [FK_Consumo_Item_Usuario_Item] FOREIGN KEY([ID_ITEM])
REFERENCES [dbo].[Item] ([ID_ITEM])
GO
ALTER TABLE [dbo].[Consumo_Item_Usuario] CHECK CONSTRAINT [FK_Consumo_Item_Usuario_Item]
GO
...
GO
ALTER TABLE [dbo].[Estado_Cliente_Estabelecimento]  WITH CHECK ADD  CONSTRAINT [FK_Estado_Cliente_Estabelecimento_Estabelecimento] FOREIGN KEY([ID_ESTABELECIMENTO])
REFERENCES [dbo].[Estabelecimento] ([ID_ESTABELECIMENTO])
GO
ALTER TABLE [dbo].[Estado_Cliente_Estabelecimento] CHECK CONSTRAINT [FK_Estado_Cliente_Estabelecimento_Estabelecimento]
GO
...
GO
ALTER TABLE [dbo].[Item]  WITH CHECK ADD  CONSTRAINT [FK_Item_Estabelecimento] FOREIGN KEY([ID_ESTABELECIMENTO])
REFERENCES [dbo].[Estabelecimento] ([ID_ESTABELECIMENTO])
GO
ALTER TABLE [dbo].[Item] CHECK CONSTRAINT [FK_Item_Estabelecimento]
GO
